  ...
  <v-container grid-list-xl>
    <v-layout row justify-center align-center wrap class="mt-4 pt-2">
      <v-flex xs12 sm12 md6 lg6 xl6>
        <h2 class="pb-4 mt-2">
          <span class="green--text">GetIn</span>
          <span>Touch</span>
        </h2>
        <div class="py-4 subheading font-weight-bold">
          <v-icon large color="green" left>fas fa-map-marker-alt</v-icon>
          <span>Jakarta,&nbsp;</span>
          <span class="green--text">Metropolitan City</span>
        </div>
        <div class="py-4 subheading font-weight-bold">
      ...
      <v-flex xs12 sm12 md6 lg6 xl6>
        ...
        <!-- ingat formspree disini gomgom223@gmail.com -->
        <form method="POST" action="https://formspree.io/f/xbjbdkyz">
          <v-text-field
            name="name"
            color="green"
...
export default {
  metaInfo: {
    title: "Contact",
    titleTemplate: "%s ← My Contacts",
    meta: [
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        name: "description",
        content:
          "My Contact Doboj Bosnia and Herzegovina Freelance Get in Touch ContactMe"
      },
      { charset: "utf-8" },
      { property: "og:title", content: "My Space" },
      { property: "og:site_name", content: "My Space" },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "" },
      {
        property: "og:image",
        content: "https://i.xx.com/Dcz2PGx.jpg"
      },
      {
